...
function Sidebar() {
  ...
  return (
    <div
      className={
        "pr-5 py-10  flex flex-col justify-between  overflow-hidden bg-white "
      }
    >
      <div />
        ...
        <ul className="w-fit mr-6">
          ...
          <li className="">
            <button
              ...
              className={`flex montserrat items-center gap-3 rounded-md mx-5 my-12 p-3 `}
            >
              <TbLogout2 />
              <h3 className="c3 font-medium">Log Out</h3>
            </button>
          </li>
        </ul>
      </div>
      <div className="p-3 gap-5 flex items-center rounded-lg border border-neutral-100 ">
        <div
          id="avatar"
        ...
        <div className="flex flex-col font-medium max-md:hidden">
          ...
          <h1 className="text-fs-10 w-[15ch] truncate">
